...
import { fundraising, troop } from "@/data/troop";
...
const ways = [
  ...
  },
  {
    ...
    amount: "$109",
    d: "Covers a Scout's national and council registration for a year.",
    tone: "blue",
  },
  {
  ...
  },
  {
    ...
    amount: "Any amount",
    d: "Tents, stoves, Dutch ovens, and the trailer that hauls them. Troop gear goes out every month and wears out honestly.",
    tone: "tan",
  },
] as const;
  ...
  return (
    <>
      ...
      <Section className="bg-shell/60">
        <SectionHead
          eyebrow="Our own fundraiser"
          title={fundraising.headline}
          lede={fundraising.detail}
        />
        <Reveal delay={80}>
          <p className="mx-auto mt-8 mb-0 max-w-2xl rounded-xl border-l-4 border-gold bg-white p-6 text-[15px] leading-7 text-slate">
            {fundraising.otherNote}
          </p>
        </Reveal>
      </Section>
